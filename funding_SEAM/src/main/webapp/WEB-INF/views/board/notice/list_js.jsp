...
//	}); */
	...
	$('#first_grid-pager>span').on('click',function(e){
		location.href="notice_list${pageMaker.makeQuery(1)}";
	});
	$('#prev_grid-pager>span').on('click',function(e){
		...
		location.href="notice_list${pageMaker.makeQuery(pageMaker.cri.page-1)}"
	});
	...
	$('#last_grid-pager>span').on('click',function(e){
		location.href="notice_list${pageMaker.makeQuery(pageMaker.realEndPage)}"
	});
