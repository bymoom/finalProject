...
<li style="width:12%;font-size:0.8em;" data-src="{{fullName}}">	
...
<script>
	...
	function getFileInfo(attachJson,contextPath){
		...
		var fileName;
		var fullName;
		//alert(attachJson.ntc_atc_fileType);
		if(attachJson.ntc_atc_fileType=="1"){
			...
			imgsrc="/displayFile?ntc_atc_fileName="+fullName;
			...
			imgsrc="/resources/images/"+icon+".png";		
		}
	...
	$('.uploadedList').on('click','.thumbnail',function(e){
		...
		var input = $('<input>').attr("name","ntc_atc_fileName")
							    .val($(this).attr("href"));
