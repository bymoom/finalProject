			...
			<form role="form" action="modify" method="post" enctype="multipart/form-data">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<label for="name">${member.mem_name }</label>
						<input type="hidden" class="form-control" placeholder="" name="mem_name" id="name" value="${member.mem_name }">
					</div>
					
					<div class="form-group">
						<label for="pw">비밀번호</label>
						<input type="password" style="width:250px;" class="form-control" placeholder="비밀번호를 입력하세요" name="mem_pw" id="pw">
					</div>
					
					<div class="form-group">
						<label for="pw2">비밀번호 확인</label>
						<input type="password" style="width:250px;" class="form-control" placeholder="비밀번호를 입력하세요" name="" id="pw2">
					</div>
					
					<div class="form-group">
						<label for="ptel">휴대폰번호 입력</label>
						<input type="text" style="width:250px;" class="form-control" id="ptel" placeholder="휴대폰번호 입력" name="mem_phone" onkeyup="inputPhoneNumber(this)" value="${member.mem_phone }">
					</div>
					...
					<div class="card-footer">
						<button type="button" class="btn btn-outline-success btn-flat" onclick="SubmitMemberModify('form');">저장하기</button>
					</div>
				</div>
			</form>
