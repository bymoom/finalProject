					...
					<div class="col-md-12">
							...
							<div class="tab-content" id="custom-content-below-tabContent">
				              <div class="tab-pane fade active show" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
					              <img src="<%=request.getContextPath() %>/resources/images/loan.jpg" style="width:70%; height:auto; margin-left: auto; margin-right: auto; display: block;"><br>
						                  		${project.pjt_contents }<br>
				              </div>
				              
				              <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
	                 			<div class="input-group input-group-sm col-12 registDiv row justify-content-md-center">
...
/* 이미 관심추가했으면 색칠된 하트로 변경 */
	...
	function goPayForm(){
		...
		var jobForm=$('#payform');
		jobForm.attr("action","loanPayForm").attr("method","post");
		jobForm.submit();
	}
