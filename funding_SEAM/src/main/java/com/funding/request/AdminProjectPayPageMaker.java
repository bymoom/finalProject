...
public class AdminProjectPayPageMaker {
	...
	private AdminProjectPaySearchCriteria cri;
	...
	public AdminProjectPaySearchCriteria getCri() {
		return cri;
	}

	public void setCri(AdminProjectPaySearchCriteria cri) {
		this.cri = cri;
	}

	@Override
	public String toString() {
		return "AdminProjectPayPageMaker [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage="
				+ endPage + ", realEndPage=" + realEndPage + ", prev=" + prev + ", next=" + next + ", displayPageNum="
