...
public class AdminComMemberDetailRequest {
	...
	private String com_state_code_val;
	...
	public AdminComMemberDetailRequest() {}

	public AdminComMemberDetailRequest(int mem_num, String mem_email, String mem_pw, String mem_name, String mem_phone,
			String mem_profile_img, String mem_profile_ori, Date mem_regdate, Date mem_lastdate, int code_state_num,
			int code_num, String code_auth, String code_state, int com_num, String com_bsns_name,
			String com_bsns_rep_name, String com_bsns_number, String com_bsns_phone, String com_bsns_reg_license,
			String com_bsns_cert, String com_zipcode, String com_addr1, String com_addr2, int com_state_code,
			String com_state_code_val, String com_state_comment, int pjt_pay_num, int pjt_pay_amount, Date ptj_pay_date,
			String pjt_pay_type, int pjt_pay_usepoint, int pjt_refund, int pjt_num, String pjt_pay_phone,
			Date pjt_pay_refund_date, Date pjt_pay_calc_date, int pjt_pay_calc_state, String pjt_title,
			String pjt_contents, int pjt_cash, String pjt_int_rate, Date pjt_startdate, Date pjt_enddate,
			Date pjt_calcdate, Date pjt_regdate, Date pjt_moddate, int pjt_view_cnt, int pjt_thumbsup, int pjt_enabled,
			String pjt_category, int pjt_type_code, int pjt_state_code, String pjt_state_comment,
			String pjt_state_code_val, String pjt_type_code_val, String comName, String comAddr1, int pjt_atc_num,
			String pjt_atc_bankbook_path, String pjt_atc_bankbook_name, String pjt_atc_sum_path,
	...
	public String toString() {
		return "AdminComMemberDetailRequest [mem_num=" + mem_num + ", mem_email=" + mem_email + ", mem_pw=" + mem_pw
				...
				+ code_auth + ", code_state=" + code_state + ", com_num=" + com_num + ", com_bsns_name=" + com_bsns_name
				...
				+ ", com_addr2=" + com_addr2 + ", com_state_code=" + com_state_code + ", com_state_code_val="
				+ com_state_code_val + ", com_state_comment=" + com_state_comment + ", pjt_pay_num=" + pjt_pay_num
				...
				+ pjt_state_code + ", pjt_state_comment=" + pjt_state_comment + ", pjt_state_code_val="
				+ pjt_state_code_val + ", pjt_type_code_val=" + pjt_type_code_val + ", comName=" + comName
				+ ", comAddr1=" + comAddr1 + ", pjt_atc_num=" + pjt_atc_num + ", pjt_atc_bankbook_path="
				+ pjt_atc_bankbook_path + ", pjt_atc_bankbook_name=" + pjt_atc_bankbook_name + ", pjt_atc_sum_path="
				+ pjt_atc_sum_path + ", pjt_atc_sum_name=" + pjt_atc_sum_name + ", pjt_atc_regdate=" + pjt_atc_regdate
				+ ", pjt_atc_moddate=" + pjt_atc_moddate + "]";
	}
