...
public class MemberRegistRequest {
	...
	private MultipartFile mem_profile_img;		//회원 프로필 경로	//modify
	private MultipartFile mem_profile_ori; 	//회원 프로필 원본
	private Date mem_regdate;  			//회원 가입일자
	private Date mem_lastdate;			//회원 마지막 접속일자
//	private int mem_point;				//회원보유 포인트
	private int code_state_num;				//회원 상태
	...
	public MemberRegistRequest(int mem_num, String mem_email, String mem_pw, String mem_name, String mem_phone,
			MultipartFile mem_profile_img, MultipartFile mem_profile_ori, Date mem_regdate, Date mem_lastdate,
			int code_state_num, int code_num, String code_auth, int login_fail_cnt, int com_num, String com_bsns_name,
			String com_bsns_rep_name, String com_bsns_number, String com_bsns_phone, MultipartFile com_bsns_reg_license,
			MultipartFile com_bsns_cert, String com_zipcode, String com_addr1, String com_addr2) {
		super();
	...
	public String toString() {
		return "MemberRegistRequest [mem_num=" + mem_num + ", mem_email=" + mem_email + ", mem_pw=" + mem_pw
				...
				+ code_auth + ", login_fail_cnt=" + login_fail_cnt + ", com_num=" + com_num + ", com_bsns_name="
...
//		member.setMem_profile_ori(mem_profile_ori);
		member.setMem_regdate(mem_regdate);
		member.setMem_lastdate(mem_lastdate);
		member.setCode_num(code_num);
		member.setCode_auth(code_auth);
		member.setCode_state_num(code_state_num);
		
		member.setCom_num(com_num);
