...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath,
		...
		//저장 경로
		String savePath=calcPath(uploadPath,mem_num);
	...
	public static String calcPath(String uploadPath,int mem_num)throws Exception{
		...
		String savePath = File.separator+mem_num+datePath;
