...
public class PaylistPageMaker {
	...
	private PaylistSearchCriteria cri; //현재 페이지 정보
	...
	public PaylistSearchCriteria getCri() {
		return cri;
		
	}
	
	public void setCri(PaylistSearchCriteria cri) {
		this.cri = cri;
	}
}