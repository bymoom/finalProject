...
public class AdminProjectPageMaker {
	...
	private AdminProjectSearchCriteria cri; //현재 페이지 정보
	...
	public AdminProjectSearchCriteria getCri() {
		return cri;
	}

	public void setCri(AdminProjectSearchCriteria cri) {
		this.cri = cri;
	}
