			...
			<div class="col-12">
				<form class="form-horizontal" name="projectModify" action="pjtModify_donation" method="post" enctype="multipart/form-data">
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" style="display: none;" name="pjt_type_code"
									class="form-control" id="pjtTitle" value="2"
						...
						<div class="form-group row">
							<label for="pjtCash" class="col-sm-3">대출 금액</label>
							<div class="col-sm-4">
						...
						<div class="form-group row">
							<label for="pjtCash" class="col-sm-3">총 상환 금액</label>
							<div class="col-sm-4">
								<input type="text" name="pjt_cash" class="form-control"
									id="a" readonly>
							</div>
						...
						<div class="form-group row">
							...
							<label class="col-sm-1 col-form-label"><a tabindex="0" class="popover-dismiss" role="button" data-toggle="popover" data-placement="right" 
