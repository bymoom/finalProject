...
public class PjtModifyRequest {
	...
	private String old_pjt_atc_bankbook_name;
	private String old_pjt_atc_sum_name;
	...
	public String getOld_pjt_atc_bankbook_name() {
		return old_pjt_atc_bankbook_name;
	}
	public void setOld_pjt_atc_bankbook_name(String old_pjt_atc_bankbook_name) {
		this.old_pjt_atc_bankbook_name = old_pjt_atc_bankbook_name;
	}
	public String getOld_pjt_atc_sum_name() {
		return old_pjt_atc_sum_name;
	}
	public void setOld_pjt_atc_sum_name(String old_pjt_atc_sum_name) {
		this.old_pjt_atc_sum_name = old_pjt_atc_sum_name;
	}
	@Override
	public String toString() {
		return "PjtModifyRequest [pjt_num=" + pjt_num + ", pjt_title=" + pjt_title + ", pjt_contents=" + pjt_contents
				...
				+ ", pjt_atc_sum_name=" + pjt_atc_sum_name + ", old_pjt_atc_bankbook_name=" + old_pjt_atc_bankbook_name
				+ ", old_pjt_atc_sum_name=" + old_pjt_atc_sum_name + "]";
	}
	
	public PjtModifyRequest() {	}
	...
	public ProjectVO toProjectVO() {
		...
		project.setPjt_state_code(pjt_state_code);
		return project;
	}
