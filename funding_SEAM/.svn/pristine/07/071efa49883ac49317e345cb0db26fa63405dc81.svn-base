...
public class NaverCaptcha {
	 public static String keyset(String id, String code, String keys) {
	     String clientId = id; //애플리케이션 클라이언트 아이디값";
	     String clientSecret = code; //애플리케이션 클라이언트 시크릿값";

	     String key = keys; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
