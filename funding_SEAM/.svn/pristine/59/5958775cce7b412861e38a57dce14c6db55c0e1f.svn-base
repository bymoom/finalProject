...
public class ProjectVO {
	...
	public ProjectVO(int pjt_num, String pjt_title, String pjt_contents, int pjt_cash, String pjt_int_rate,
			...
			String pjt_state_code_val, String pjt_type_code_val, int pjtPaySum, String pjt_atc_sum_name, String comName,
			String comAddr1) {
		super();
	...
	public String toString() {
		return "ProjectVO [pjt_num=" + pjt_num + ", pjt_title=" + pjt_title + ", pjt_contents=" + pjt_contents
				...
				+ pjt_state_comment + ", pjt_calculate_code=" + pjt_calculate_code + ", pjt_repaydate=" + pjt_repaydate
				+ ", pjt_state_code_val=" + pjt_state_code_val + ", pjt_type_code_val=" + pjt_type_code_val
				+ ", pjtPaySum=" + pjtPaySum + ", pjt_atc_sum_name=" + pjt_atc_sum_name + ", comName=" + comName
				+ ", comAddr1=" + comAddr1 + "]";
	}
